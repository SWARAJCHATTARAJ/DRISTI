...
VAL_FILE = "data/validation_real.json"
...
print("=" * 70)
print("              DRISTI v0.6 DEBERTA TRAINING")
print("=" * 70)
...
# Force the dataset to use DeBERTa tokenizer
from transformers import AutoTokenizer
train_dataset.tokenizer = AutoTokenizer.from_pretrained(MODEL_NAME, use_fast=False)
...
# Replace standard CrossEntropy with Focal Loss to handle rare edge cases
binary_loss_fn = FocalLoss(gamma=2.0)
choice_loss_fn = FocalLoss(gamma=2.0)
...
# MIXED PRECISION
# ============================================================
# DeBERTa-v3 often throws 'Attempting to unscale FP16 gradients' in FP16 AMP.
# Disabling AMP forces stable FP32 training.
use_amp = False
